...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleShardNotFound(ShardNotFoundException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleParseGoneWrong(ParseGoneWrongException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleIndexInit(IndexInitializationException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleIndexOp(IndexOperationException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleGenericIndexService(ServiceException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleGrpcStatus(StatusRuntimeException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleHttpMessageNotReadable(
        ...
        ErrorResponse body =
                new ErrorResponse(status.value(), status.getReasonPhrase(), detail, request.getRequestURI());
        return new ResponseEntity<>(body, status);
    }
    ...
    public ResponseEntity<ErrorResponse> handleResponseStatus(ResponseStatusException ex, HttpServletRequest request) {
        ...
        ErrorResponse body =
                new ErrorResponse(status.value(), status.getReasonPhrase(), ex.getReason(), request.getRequestURI());
        return new ResponseEntity<>(body, status);
    }
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(Exception ex, HttpServletRequest request) {
        ...
        HttpStatus status = HttpStatus.INTERNAL_SERVER_ERROR;
        ErrorResponse body = new ErrorResponse(
                status.value(), status.getReasonPhrase(), "Internal server error", request.getRequestURI());
        return new ResponseEntity<>(body, status);
    }
}
