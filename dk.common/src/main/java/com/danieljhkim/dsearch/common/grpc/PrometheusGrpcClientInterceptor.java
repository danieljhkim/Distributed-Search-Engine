...
public class PrometheusGrpcClientInterceptor implements ClientInterceptor {
    ...
    /**
     * component = logical caller, e.g. "gateway->query-node" or "gateway->index-node"
     */
    ...
    public <ReqT, RespT> ClientCall<ReqT, RespT> interceptCall(
        ...
        return new ForwardingClientCall.SimpleForwardingClientCall<>(delegate) {
            ...
            public void start(Listener<RespT> responseListener, Metadata headers) {
                Listener<RespT> timingListener = new ForwardingClientCallListener.SimpleForwardingClientCallListener<>(responseListener) {
