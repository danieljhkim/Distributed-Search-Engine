...
export DSEARCH_BENCH_SEARCH_TYPE="${DSEARCH_BENCH_SEARCH_TYPE:-HYBRID}"

echo "Running k6 HYBRID benchmark against $DSEARCH_GATEWAY_BASE_URL$DSEARCH_GATEWAY_SEARCH_PATH"
k6 run "$BENCH_DIR/k6/hybrid_search.js"